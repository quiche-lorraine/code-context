                    ...
                    ->children()
                        ...
                        ->arrayNode('docs')
                            ...
                            ->children()
                                ...
                                ->integerNode('summary_max_chars')->min(50)->defaultValue(500)->end()
                                ->integerNode('content_max_bytes')->min(1024)->defaultValue(8192)->end()
                            ->end()
                        ->end()
                        ->arrayNode('symfony')
                            ->addDefaultsIfNotSet()
                        ...
                        ->arrayNode('vendor_contracts')
                            ...
                            ->children()
                                ...
                                ->integerNode('max_classes')->min(1)->defaultValue(100)->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ...
                        ->arrayNode('markdown')
                            ...
                            ->children()
                                ...
                                ->enumNode('agents_mode')
                                    ->values(['full', 'namespaces_only', 'top_level_only'])
                                    ->defaultValue('full')
                                ->end()
                            ->end()
                        ->end()
